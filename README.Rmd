...
extraction, permutation, and matching in R.
...
`permutation_join()` matches rows when any generated permutation overlaps:
...
vectors. To clear caches in a long-running session:
