...
| TR-PS-s1-the-18-public-fields-three-value | SETTLED | UNASSIGNED | UNASSIGNED | `design/work/url-v3/contracts/public-surface-closure.md:222` |
| TR-PS-s1-parse-status-l1-l2-l3-compat-pro | SETTLED | UNASSIGNED | UNASSIGNED | `design/work/url-v3/contracts/public-surface-closure.md:223` |
| TR-PS-s1-clean-url-clean-surface-c-not-id | SETTLED | UNASSIGNED | UNASSIGNED | `design/work/url-v3/contracts/public-surface-closure.md:224` |
| TR-PS-s1-comparison-key-get-url-key-not-c | SETTLED | UNASSIGNED | UNASSIGNED | `design/work/url-v3/contracts/public-surface-closure.md:225` |
| TR-PS-s1-host-domain-psl-registrable-not- | SETTLED | UNASSIGNED | UNASSIGNED | `design/work/url-v3/contracts/public-surface-closure.md:226` |
| TR-PS-s1-cache-config-info-clear-semantic | SETTLED | UNASSIGNED | UNASSIGNED | `design/work/url-v3/contracts/public-surface-closure.md:227` |
| TR-PS-s1-scheme-admission-interpretation- | SETTLED | UNASSIGNED | UNASSIGNED | `design/work/url-v3/contracts/public-surface-closure.md:228` |
| TR-PS-s1-companion-helpers-never-widen-th | SETTLED | UNASSIGNED | UNASSIGNED | `design/work/url-v3/contracts/public-surface-closure.md:229` |
