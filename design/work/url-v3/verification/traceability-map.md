...
| TR-KJ-s4-eligibility-vocabulary | SETTLED | join-slice | PENDING | `design/work/url-v3/contracts/key-join-contracts.md:149` |
| TR-KJ-s4-warning-rows | SETTLED | join-slice | PENDING | `design/work/url-v3/contracts/key-join-contracts.md:150` |
| TR-KJ-s4-non-keyable-rows | SETTLED | join-slice | PENDING | `design/work/url-v3/contracts/key-join-contracts.md:151` |
| TR-KJ-s4-missing-matching | SETTLED | join-slice | PENDING | `design/work/url-v3/contracts/key-join-contracts.md:152` |
| TR-KJ-s4-key-collision | SETTLED | join-slice | PENDING | `design/work/url-v3/contracts/key-join-contracts.md:153` |
| TR-KJ-s4-duplicate-keys | SETTLED | join-slice | PENDING | `design/work/url-v3/contracts/key-join-contracts.md:154` |
| TR-KJ-s4-resource-guard | SETTLED | join-slice | PENDING | `design/work/url-v3/contracts/key-join-contracts.md:155` |
| TR-KJ-s5-url-inner-join-x-y | SETTLED | join-slice | PENDING | `design/work/url-v3/contracts/key-join-contracts.md:165` |
| TR-KJ-s5-url-left-join-x-y | SETTLED | join-slice | PENDING | `design/work/url-v3/contracts/key-join-contracts.md:166` |
| TR-KJ-s5-url-right-join-x-y | OPEN | join-slice | PENDING | `design/work/url-v3/contracts/key-join-contracts.md:167` |
| TR-KJ-s5-url-full-join-x-y | SETTLED | join-slice | PENDING | `design/work/url-v3/contracts/key-join-contracts.md:168` |
| TR-KJ-s5-url-semi-join-x-y | SETTLED | join-slice | PENDING | `design/work/url-v3/contracts/key-join-contracts.md:169` |
| TR-KJ-s5-url-anti-join-x-y | OPEN | join-slice | PENDING | `design/work/url-v3/contracts/key-join-contracts.md:170` |
| TR-KJ-s6-url-columns | OPEN | join-slice | PENDING | `design/work/url-v3/contracts/key-join-contracts.md:176` |
| TR-KJ-s6-key-policy | SETTLED | join-slice | PENDING | `design/work/url-v3/contracts/key-join-contracts.md:177` |
| TR-KJ-s6-parse-policy | SETTLED | join-slice | PENDING | `design/work/url-v3/contracts/key-join-contracts.md:178` |
| TR-KJ-s6-relationship | SETTLED | join-slice | PENDING | `design/work/url-v3/contracts/key-join-contracts.md:179` |
| TR-KJ-s6-multiple-matches | SETTLED | join-slice | PENDING | `design/work/url-v3/contracts/key-join-contracts.md:180` |
| TR-KJ-s6-duplicate-counts | SETTLED | join-slice | PENDING | `design/work/url-v3/contracts/key-join-contracts.md:181` |
| TR-KJ-s6-invalid-warnings | SETTLED | join-slice | PENDING | `design/work/url-v3/contracts/key-join-contracts.md:182` |
| TR-KJ-s6-key-visibility | OPEN | join-slice | PENDING | `design/work/url-v3/contracts/key-join-contracts.md:183` |
| TR-KJ-s6-original-urls | SETTLED | join-slice | PENDING | `design/work/url-v3/contracts/key-join-contracts.md:184` |
| TR-KJ-s6-suffix-name-repair | OPEN | join-slice | PENDING | `design/work/url-v3/contracts/key-join-contracts.md:185` |
| TR-KJ-s6-row-order-except-right-join | SETTLED | join-slice | PENDING | `design/work/url-v3/contracts/key-join-contracts.md:186` |
| TR-KJ-s6-type-attributes | OPEN | join-slice | PENDING | `design/work/url-v3/contracts/key-join-contracts.md:187` |
| TR-KJ-s6-conditions | SETTLED | join-slice | PENDING | `design/work/url-v3/contracts/key-join-contracts.md:188` |
| TR-KJ-s6-resource-bound | SETTLED | join-slice | PENDING | `design/work/url-v3/contracts/key-join-contracts.md:189` |
| TR-KJ-s6-diagnostics | SETTLED | join-slice | PENDING | `design/work/url-v3/contracts/key-join-contracts.md:190` |
| TR-KJ-s7-legacy-freeze | SETTLED | migration-slice | PENDING | `design/work/url-v3/contracts/key-join-contracts.md:200` |
| TR-KJ-s7-implicit-equality-dials | SETTLED | migration-slice | PENDING | `design/work/url-v3/contracts/key-join-contracts.md:201` |
| TR-KJ-s7-identity-opt-in | SETTLED | migration-slice | PENDING | `design/work/url-v3/contracts/key-join-contracts.md:202` |
| TR-KJ-s7-six-join-replacement | SETTLED | migration-slice | PENDING | `design/work/url-v3/contracts/key-join-contracts.md:203` |
| TR-KJ-s7-audit-before-switch | SETTLED | migration-slice | PENDING | `design/work/url-v3/contracts/key-join-contracts.md:204` |
| TR-KJ-s7-current-formal-migration | SETTLED | migration-slice | PENDING | `design/work/url-v3/contracts/key-join-contracts.md:205` |
| TR-KJ-s7-forwarded-parse-dials | SETTLED | migration-slice | PENDING | `design/work/url-v3/contracts/key-join-contracts.md:206` |
| TR-KJ-s7-forwarded-display-cleaning-dials | SETTLED | migration-slice | PENDING | `design/work/url-v3/contracts/key-join-contracts.md:207` |
| TR-KJ-s7-path-encoding-regression | SETTLED | migration-slice | PENDING | `design/work/url-v3/contracts/key-join-contracts.md:208` |
| TR-KJ-s7-removal-default-flip | SETTLED | migration-slice | PENDING | `design/work/url-v3/contracts/key-join-contracts.md:209` |
...
| TR-PS-s1-the-18-public-fields-three-value | SETTLED | UNASSIGNED | UNASSIGNED | `design/work/url-v3/contracts/public-surface-closure.md:225` |
| TR-PS-s1-parse-status-l1-l2-l3-compat-pro | SETTLED | UNASSIGNED | UNASSIGNED | `design/work/url-v3/contracts/public-surface-closure.md:226` |
| TR-PS-s1-clean-url-clean-surface-c-not-id | SETTLED | UNASSIGNED | UNASSIGNED | `design/work/url-v3/contracts/public-surface-closure.md:227` |
| TR-PS-s1-comparison-key-get-url-key-not-c | SETTLED | UNASSIGNED | UNASSIGNED | `design/work/url-v3/contracts/public-surface-closure.md:228` |
| TR-PS-s1-host-domain-psl-registrable-not- | SETTLED | UNASSIGNED | UNASSIGNED | `design/work/url-v3/contracts/public-surface-closure.md:229` |
| TR-PS-s1-cache-config-info-clear-semantic | SETTLED | UNASSIGNED | UNASSIGNED | `design/work/url-v3/contracts/public-surface-closure.md:230` |
| TR-PS-s1-scheme-admission-interpretation- | SETTLED | UNASSIGNED | UNASSIGNED | `design/work/url-v3/contracts/public-surface-closure.md:231` |
| TR-PS-s1-companion-helpers-never-widen-th | SETTLED | UNASSIGNED | UNASSIGNED | `design/work/url-v3/contracts/public-surface-closure.md:232` |
...
| TR-PSD-s2-get-url-key | SETTLED | UNASSIGNED | UNASSIGNED | `design/work/url-v3/contracts/public-surface-disposition.md:120` |
| TR-PSD-s2-get-user | OPEN | UNASSIGNED | UNASSIGNED | `design/work/url-v3/contracts/public-surface-disposition.md:121` |
| TR-PSD-s2-get-userinfo | OPEN | UNASSIGNED | UNASSIGNED | `design/work/url-v3/contracts/public-surface-disposition.md:122` |
| TR-PSD-s2-is-valid-host | OPEN | UNASSIGNED | UNASSIGNED | `design/work/url-v3/contracts/public-surface-disposition.md:123` |
| TR-PSD-s2-query-param-summary | OPEN | UNASSIGNED | UNASSIGNED | `design/work/url-v3/contracts/public-surface-disposition.md:124` |
| TR-PSD-s2-resolve-url | OPEN | UNASSIGNED | UNASSIGNED | `design/work/url-v3/contracts/public-surface-disposition.md:125` |
| TR-PSD-s2-rurl-cache-config | SETTLED | UNASSIGNED | UNASSIGNED | `design/work/url-v3/contracts/public-surface-disposition.md:126` |
| TR-PSD-s2-rurl-cache-info | SETTLED | UNASSIGNED | UNASSIGNED | `design/work/url-v3/contracts/public-surface-disposition.md:127` |
| TR-PSD-s2-rurl-clear-caches | SETTLED | UNASSIGNED | UNASSIGNED | `design/work/url-v3/contracts/public-surface-disposition.md:128` |
| TR-PSD-s2-safe-parse-url | SETTLED | UNASSIGNED | UNASSIGNED | `design/work/url-v3/contracts/public-surface-disposition.md:129` |
| TR-PSD-s2-safe-parse-urls | OPEN | UNASSIGNED | UNASSIGNED | `design/work/url-v3/contracts/public-surface-disposition.md:130` |
| TR-PSD-s2-serialize-url | SETTLED | UNASSIGNED | UNASSIGNED | `design/work/url-v3/contracts/public-surface-disposition.md:131` |
| TR-PSD-s2-url-anti-join | SETTLED | UNASSIGNED | UNASSIGNED | `design/work/url-v3/contracts/public-surface-disposition.md:132` |
| TR-PSD-s2-url-full-join | SETTLED | UNASSIGNED | UNASSIGNED | `design/work/url-v3/contracts/public-surface-disposition.md:133` |
| TR-PSD-s2-url-inner-join | SETTLED | UNASSIGNED | UNASSIGNED | `design/work/url-v3/contracts/public-surface-disposition.md:134` |
| TR-PSD-s2-url-key-policy | SETTLED | UNASSIGNED | UNASSIGNED | `design/work/url-v3/contracts/public-surface-disposition.md:135` |
| TR-PSD-s2-url-left-join | SETTLED | UNASSIGNED | UNASSIGNED | `design/work/url-v3/contracts/public-surface-disposition.md:136` |
| TR-PSD-s2-url-profile | OPEN | UNASSIGNED | UNASSIGNED | `design/work/url-v3/contracts/public-surface-disposition.md:137` |
| TR-PSD-s2-url-right-join | SETTLED | UNASSIGNED | UNASSIGNED | `design/work/url-v3/contracts/public-surface-disposition.md:138` |
| TR-PSD-s2-url-semi-join | SETTLED | UNASSIGNED | UNASSIGNED | `design/work/url-v3/contracts/public-surface-disposition.md:139` |
| TR-PSD-s3-original-url | OPEN | UNASSIGNED | UNASSIGNED | `design/work/url-v3/contracts/public-surface-disposition.md:145` |
| TR-PSD-s3-scheme | SETTLED | UNASSIGNED | UNASSIGNED | `design/work/url-v3/contracts/public-surface-disposition.md:146` |
| TR-PSD-s3-host | OPEN | UNASSIGNED | UNASSIGNED | `design/work/url-v3/contracts/public-surface-disposition.md:147` |
| TR-PSD-s3-port | SETTLED | UNASSIGNED | UNASSIGNED | `design/work/url-v3/contracts/public-surface-disposition.md:148` |
| TR-PSD-s3-path | SETTLED | UNASSIGNED | UNASSIGNED | `design/work/url-v3/contracts/public-surface-disposition.md:149` |
| TR-PSD-s3-query | OPEN | UNASSIGNED | UNASSIGNED | `design/work/url-v3/contracts/public-surface-disposition.md:150` |
| TR-PSD-s3-fragment | SETTLED | UNASSIGNED | UNASSIGNED | `design/work/url-v3/contracts/public-surface-disposition.md:151` |
| TR-PSD-s3-user | OPEN | UNASSIGNED | UNASSIGNED | `design/work/url-v3/contracts/public-surface-disposition.md:152` |
| TR-PSD-s3-password | OPEN | UNASSIGNED | UNASSIGNED | `design/work/url-v3/contracts/public-surface-disposition.md:153` |
| TR-PSD-s3-domain | OPEN | UNASSIGNED | UNASSIGNED | `design/work/url-v3/contracts/public-surface-disposition.md:154` |
| TR-PSD-s3-tld | OPEN | UNASSIGNED | UNASSIGNED | `design/work/url-v3/contracts/public-surface-disposition.md:155` |
| TR-PSD-s3-domain-ascii | SETTLED | UNASSIGNED | UNASSIGNED | `design/work/url-v3/contracts/public-surface-disposition.md:156` |
| TR-PSD-s3-domain-unicode | SETTLED | UNASSIGNED | UNASSIGNED | `design/work/url-v3/contracts/public-surface-disposition.md:157` |
| TR-PSD-s3-tld-ascii | SETTLED | UNASSIGNED | UNASSIGNED | `design/work/url-v3/contracts/public-surface-disposition.md:158` |
| TR-PSD-s3-tld-unicode | SETTLED | UNASSIGNED | UNASSIGNED | `design/work/url-v3/contracts/public-surface-disposition.md:159` |
| TR-PSD-s3-is-ip-host | SETTLED | UNASSIGNED | UNASSIGNED | `design/work/url-v3/contracts/public-surface-disposition.md:160` |
| TR-PSD-s3-clean-url | SETTLED | UNASSIGNED | UNASSIGNED | `design/work/url-v3/contracts/public-surface-disposition.md:161` |
| TR-PSD-s3-parse-status | OPEN | UNASSIGNED | UNASSIGNED | `design/work/url-v3/contracts/public-surface-disposition.md:162` |
| TR-PSD-s4-curl-import-metadata | OPEN | migration-slice | PENDING | `design/work/url-v3/contracts/public-surface-disposition.md:168` |
| TR-PSD-s4-curl-parse-call | OPEN | migration-slice | PENDING | `design/work/url-v3/contracts/public-surface-disposition.md:169` |
| TR-PSD-s4-curl-escape-unescape | OPEN | migration-slice | PENDING | `design/work/url-v3/contracts/public-surface-disposition.md:170` |
| TR-PSD-s4-migration-surface | SETTLED | migration-slice | PENDING | `design/work/url-v3/contracts/public-surface-disposition.md:171` |
