...
|---|---|---|---|
| exported functions | 41 | `NAMESPACE` `export(...)` (41 lines; all functions, zero data) | SETTLED (`NAMESPACE` is the source of truth; the validator checks this roster against it by name) |
