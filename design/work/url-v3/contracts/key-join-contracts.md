...
- **KJ-O9 — `scheme_relative_handling`'s D-E.4 disposition.** D-E.4's argument
  ...
  artifact 8's authority rather than this contract's. **Settles at:** the P3
  closure decision, by either extending D-E's parse-dial list to four axes or
  ruling it a presentation dial.
