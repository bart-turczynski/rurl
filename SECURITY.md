...
| Version                     | Supported          |
| --------------------------- | ------------------ |
| Latest CRAN release (1.4.x) | :white_check_mark: |
| Older releases              | :x:                |
...
no network connections of its own and handles no credentials, so its security
surface is limited to the safe handling of untrusted URL input.
